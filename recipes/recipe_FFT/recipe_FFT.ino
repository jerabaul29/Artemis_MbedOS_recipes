...
// very strange: if this is commented, then error
// #error "Define according the used Cortex core ARM_MATH_CM7, ARM_MATH_CM4, ARM_MATH_CM3, ARM_MATH_CM0PLUS, ARM_MATH_CM0, ARM_MATH_ARMV8MBL, ARM_MATH_ARMV8MML"
// but if it is uncommented then warning
// /home/jrlab/Desktop/Git/Artemis_MbedOS_recipes/recipes/recipe_FFT/recipe_FFT.ino:8: warning: "ARM_MATH_CM4" redefined
...
uint8_t forward_fft = 0;
uint8_t backward_fft = 1;

// Global variables for taking FFT
float32_t fft_input[SAMPLES];
float32_t fft_output[FFT_SIZE];
float32_t * fft_input_p = fft_input;
float32_t * fft_output_p = fft_output;
...
void setup() {
  ...
  arm_rfft_fast_f32(&crrt_arm_rfft_fast_instance_f32, fft_input_p, fft_output_p, forward_fft);    // take the FFT
}
